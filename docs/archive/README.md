...
|---|---|---|
| [`mvp-scope-memo.md`](mvp-scope-memo.md) | Day-3 MVP scope memo (single-vault → marketplace pivot framing) | [`docs/user-stories.md`](../user-stories.md) for the product spine; [`AUDIT_2026-06-14.md`](../../AUDIT_2026-06-14.md) for current submission scope |
...
| [`launch-plan-2026-05-19.md`](launch-plan-2026-05-19.md) | Day-8 coordinated 3-repo reveal launch plan | Launch executed during the Day-12 / Day-13 window (HTTPS landed via PR #240; demo recorded; v1 form submitted). Forward planning now lives in [`AUDIT_2026-06-14.md`](../../AUDIT_2026-06-14.md). |
...
| [`sunday-night-handoff-2026-05-24.md`](sunday-night-handoff-2026-05-24.md) | Post-HTTPS-landing Sunday-night handoff between Claude sessions | HTTPS live; wallet flow shipped; the remaining priorities (verify_arc_e2e --execute, v_check production validation, judge-trust polish) folded into [`AUDIT_2026-06-14.md`](../../AUDIT_2026-06-14.md). |
