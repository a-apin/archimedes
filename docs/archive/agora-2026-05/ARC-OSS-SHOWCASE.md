...
- ✅ **Documentation explains functionality and usage** — every primitive has a per-primitive spec doc; project-level docs in [`README.md`](../../../README.md), [`SETUP.md`](../../../SETUP.md), [`OPERATIONS.md`](../../runbooks/operations.md), [`ARC.md`](../../arc-integration.md), and [`docs/`](../../README.md)
...
| [`docs/specs/strategy-passport-spec.md`](../../specs/strategy-passport-spec.md) | The full spec: required fields, semantics, integration with on-chain anchoring |
...
| `backend/archimedes/services/selection_bias.py` (since removed) | The earlier `RigorGateResult` + look-ahead audit (AST-based static analysis) — 534 lines |
...
| [`docs/specs/selection-bias-corrections-spec.md`](../../specs/selection-bias-corrections-spec.md) | Math + thresholds + spec sanity cases |
| [`docs/rigor-methods.md`](../../rigor-methods.md) | Plain-English companion |
...
| [`docs/specs/ipfs-reasoning-traces-design-note.md`](../../specs/ipfs-reasoning-traces-design-note.md) | The IPFS pinning extension (Hash → Pinata CID → on-chain anchor; Rosetta-Alpha pattern) |
| [`docs/specs/commit-reveal-trace-spec.md`](../../specs/commit-reveal-trace-spec.md) | v1.5 upgrade: commit-before-trade / reveal-after-trade for proven causal ordering |
...
| [`docs/corpus-architecture.md`](../../corpus-architecture.md) | The 3-layer substrate walkthrough end-to-end (seed → DB → artifact); wired-vs-not-yet table |
...
| Where it lives | What it is |
|---|---|
| [`backend/archimedes/agents/strategy_fusion.py`](../../../backend/archimedes/agents/strategy_fusion.py) | `FusionBrief`, `CorpusPaper`, `load_corpus()`, the LLM prompt build — 650 lines |
| [`docs/specs/strategy-fusion-spec.md`](../../specs/strategy-fusion-spec.md) | The spec: feature-flagged shape, novelty rationale, persistence contract |
...
| [`docs/specs/xia-2026-protocols.md`](../../specs/xia-2026-protocols.md) | Full reference — maps each protocol to the section of the Xia paper it implements. |
...
| [`docs/benchmarks/stockbench-results.md`](../../benchmarks/stockbench-results.md) | Our published result + methodology so a forker can re-derive. |
