...
- ✅ **Live testnet deploy** at `https://archimedes-arc.com/` (EC2 `13.40.112.220`) with the full spine (Landing / Generate / Library / Corpus / Portfolio / Reasoning / Learnings) and the agentic advisor wired end-to-end.
...
- ❌ **Coordinated launch reach** — the launch plan (`docs/archive/launch-plan-2026-05-19.md`) targeted a 1–3 day window before submission. Execution depends on the team converging on timing + sharing the splash through real channels.
