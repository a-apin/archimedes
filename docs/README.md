...
| Doc | Status | Owner | Last verified | What it is |
|---|---|---|---|---|
| [`account-authentication.md`](account-authentication.md) | runbook | Daniel Reis | 2026-08 | Better Auth deploy runbook: secrets, ECR, rollback (#1194); account linking, implicit + explicit (#1420 follow-up). |
