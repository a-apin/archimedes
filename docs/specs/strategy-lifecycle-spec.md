...
|---|---|---|
| → Generated | Agent emits final `candidate_drafted` SSE event with rigor verdict | DB insert; trace persisted off-chain via `AgentStateStore` (`backend/archimedes/services/redis_state.py`) |
