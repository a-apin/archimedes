      ...
      <div style={{ marginBottom: 18 }}>
        <header className="app-page-heading">
          ...
          {/* Board switch. Two surfaces, two bases, never averaged — the labels
              say which is which before a single number is read. It sits between
              the title and the blurb because the blurb below is board-specific:
              the reader must know which board they are on before they read what
              its numbers mean. */}
