  ...
  return (
    <div className="leaderboard-page" style={{ maxWidth: 1100 }}>
      <div style={{ marginBottom: 18 }}>
        {/* Rebrand shell (eyebrow + h1) wrapping #1563's two-board split. The
            heading level and chrome are the rebrand's; every word and every
            gate inside is main's — the board switch still precedes any number,
            and each board's basis copy is still rendered by its own guard. */}
