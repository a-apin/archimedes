		...
		<div className="max-w-[820px] mb-7">
			...
			<p className="body mb-2">
				{ROADMAP_SURFACES_ENABLED
					? "Archimedes turns quantitative-finance research into strategies you can actually inspect: generated by a multi-agent debate, admitted only through a statistical rigor gate, executed into a vault that stays yours, with every decision hashed on-chain before the trade that acts on it."
					: "Archimedes turns quantitative-finance research into strategies you can actually inspect: generated by a multi-agent debate, admitted only through a statistical rigor gate before anything can run live."}
			</p>
			...
			<div className="table-container mb-3">
				<table>
					...
					<tbody>
						...
						{ROADMAP_SURFACES_ENABLED && (
							<tr>
								<td>{ROADMAP_COPY.ledgerVaultLabel}</td>
								<td>
