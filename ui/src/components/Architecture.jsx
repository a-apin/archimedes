...
function OnChainExecutionRoadmap({ contracts, contractsError }) {
	return (
		<div className="card p-5 mb-7">
			...
			<p className="caption" style={{ color: "var(--text-3)" }}>
				What is live on-chain today is provenance, not execution: reasoning
				records are content-hashed and anchored so they can be re-checked
				later (see the section below). Settlement, when execution ships, is
				USDC on Arc testnet
				{contractsError
	...
	return (
		<div className="card p-5 mb-7">
			...
			<p className="caption mb-4" style={{ color: "var(--text-3)" }}>
				Read this as the ordering rule the contracts enforce, not as a claim
				about trading volume: the anchoring half runs today, while the trade
				half belongs to the execution path described above as roadmap.
			</p>
...
const PROTOCOLS = [
	...
	},
	{
		...
		what: "Chain state outranks the LLM's narrative — the rebalance loop reads holdings from chain, never from model output; V_check then caps any single position at 60% concentration and rejects a malformed weight set before the trade is committed.",
	},
	{
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								contract-enforced ordering; anchoring runs today, and the trade
