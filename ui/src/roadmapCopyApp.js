...
// Strategies.jsx — chunk `AuthenticatedApp-*.js`). See roadmapCopy.js for
// the full rationale, the JSX-in-.js constraint, and why this is a separate
// file from the public-pages copy rather than one shared module.
